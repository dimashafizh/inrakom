...
$dataKehilangan = $kehilangan->getAllDatakehilangan();
$radioList = $kehilangan->getRadioList();

    // Untuk update informasi kehilangan
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_kehilangan'])) {
        ...
        if ($kehilangan->updateKehilangan($id_peminjaman, $id_radio, $nomor_sn, $catatan, $tanggal_baru)) {
            $_SESSION['alert'] = ['type' => 'primary', 'message' => 'Berhasil memperbarui data kehilangan'];
            header("Location: kehilangan.php");
            exit;
        } else {
            $_SESSION['alert'] = ['type' => 'danger', 'message' => 'Gagal memperbarui data kehilangan'];
        }
    }

// Untuk hapus data kehilangan
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['hapus_kehilangan'])) {
    $id_peminjaman = $_POST['id_peminjaman'];
    $hapus = $kehilangan->hapusKehilangan($id_peminjaman);

    if ($hapus === true) {
        $_SESSION['alert'] = ['type' => 'dark', 'message' => 'Data kehilangan telah dihapus!'];
        header("Location: kehilangan.php");
        exit;
    } elseif ($hapus === 'used') {
        $_SESSION['alert'] = ['type' => 'warning', 'message' => 'Data kehilangan tidak bisa dihapus karena sedang digunakan dalam tabel pendataan'];
        header("Location: kehilangan.php");
        exit;
    } else {
        $_SESSION['alert'] = ['type' => 'danger', 'message' => 'Gagal menghapus data kehilangan'];
    }
}
...
if (isset($_POST['filter_tanggal'])) {
    ...
    $dataKehilangan = $kehilangan->getDataKehilanganByTanggal($tanggal_mulai, $tanggal_selesai);
} else {
    $dataKehilangan = $kehilangan->getDataKehilanganByTanggal();
}
...
<html lang="en">
    <head>
        ...
        <title>Kehilangan | INRAKOM BINSUA</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4"><i class="fa-solid fa-ban"></i> Data Kehilangan Radio Komunikasi</h1>
                        
                        <div class="card mb-4">
                            <div class="card-header">
                                <a href="exportdata-kehilangan.php" class="btn btn-secondary">Export Data</a>
                                <br>
                                <div class="row mt-4">
                                    <div class="mb-3">
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <?php
                                        ...
                                        foreach ($dataKehilangan as $row) {
                                            ...
                                            // Modal Edit untuk data kehilangan
                                            echo "
                                            <div class='modal fade' id='edit-{$row['id_peminjaman']}'>
                                                <div class='modal-dialog'>
                                                    <div class='modal-content'>
                                                        <div class='modal-header'>
                                                            <h4 class='modal-title'><i class='fa-solid fa-pen-to-square'></i> Edit Data Kehilangan</h4>
                                            ...
                                            echo "              </select>
                                                            ...
                                                            <div class='modal-footer'>
                                                                <button type='submit' name='update_kehilangan' class='btn btn-primary'>Update</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            // Modal untuk hapus data kehilangan
                                            echo "
                                            <div class='modal fade' id='hapus-{$row['id_peminjaman']}'>
                                                <div class='modal-dialog'>
                                                    <div class='modal-content'>
                                                        <div class='modal-header'>
                                                            <h4 class='modal-title'><i class='fa-solid fa-triangle-exclamation'></i> Konfirmasi Hapus Data Kehilangan</h4>
                                                            <button type='button' class='btn-close' data-bs-dismiss='modal'></button>
                                                        </div>
                                                        ...
                                                        <div class='modal-footer'>
                                                            <form method='POST' action=''>
                                                                <input type='hidden' name='id_peminjaman' value='{$row['id_peminjaman']}'>
                                                                <button type='submit' name='hapus_kehilangan' class='btn btn-danger'>Ya, hapus!</button>
                                                            </form>
                                                        </div>
                                                    </div>
                                                </div>
